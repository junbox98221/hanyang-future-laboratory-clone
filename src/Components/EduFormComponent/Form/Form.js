    ...
    <Div>
      <InlineBlock>
        ...
        <Section>
          ...
          <input
            ...
            required="required"
            type="text"
            placeholder="예시) 00청소년센터 or 00초등학교"
          />
        </Section>
        <Section>
      ...
      <InlineBlock>
        ...
        <Section>
          ...
          <input className="input" required="required" type="text" />
          <Para>
            최소 인원 20명 미만일 경우, 20명 기준으로 비용이 집행됩니다.
          </Para>
        </Section>
        <Section>
      ...
      <Modal isOpen={modalIsOpen} className="Modal">
        <button onClick={() => setModalIsOpen(false)} className="unsetButton">
          X
        </button>
        ...
        <Ul>
          <Li>
            수집항목: 이름, 생년월일, 성별, 로그인ID, 비밀번호, 비밀번호 질문과
            답변, 자택 전화번호, 자택 주소, 휴대전화 번호, 이메일, 쿠키,
            결제기록
          </Li>
        ...
        <Ul>
          <Li>
            ...
            제공, 구매 및 요금 결제, 물품배송 또는 청구지 등 발송, 금융거래 본인
            인증 및 금융 서비스
          </Li>
          <Li>
            회원관리: 회원제 서비스 이용에 따른 본인확인, 개인 식별, 불량회원의
            부정 이용 방지와 비인가 사용 방지, 가입 의사 확인, 연령확인,
            불만처리 등 민원 처리, 고지사항 전달
          </Li>
          <Li>
